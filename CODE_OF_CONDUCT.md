...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported through the repository's [GitHub Issues](https://github.com/Xhoryon/cc-switch-duo-usage-plugin/issues). All complaints will be reviewed and investigated promptly and fairly.
...
辱骂、骚扰或其他不可接受的行为可通过仓库的 [GitHub Issues](https://github.com/Xhoryon/cc-switch-duo-usage-plugin/issues) 向负责监督的社区领袖报告。所有投诉都将得到及时和公平的审查和调查。
