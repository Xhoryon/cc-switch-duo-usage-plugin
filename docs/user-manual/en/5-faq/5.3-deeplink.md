...
Deep links can be created manually or with a trusted external generator. This
repository does not publish a generator or embed credential-bearing examples.
